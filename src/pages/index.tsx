  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Navigate Your Dining Experience with Restaurant Booking Engine - Streamlining Reservations and Menu Management for Exceptional Service"
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Navigate Your Dining Experience with Restaurant Booking Engine - Streamlining Reservations and Menu Management for Exceptional Service`}
            </Text>
            <Box
